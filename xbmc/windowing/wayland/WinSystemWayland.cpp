...
{
  CSingleLock lock(m_seatProcessorsMutex);
  auto newSeatEmplace = m_seatProcessors.emplace(std::piecewise_construct, std::forward_as_tuple(name), std::forward_as_tuple(name, seat, static_cast<IInputHandler&> (*this)));
